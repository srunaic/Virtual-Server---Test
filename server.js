...
const io = new Server(server, {
    cors: {
        origin: ["http://localhost:3000", "https://srunaic.github.io", "https://orange-teams-listen.loca.lt", "https://wild-nights-spend.loca.lt", "https://cyan-singers-rush.loca.lt", "https://solid-pans-doubt.loca.lt", "*"],
        methods: ["GET", "POST"],
        credentials: true
    }
});
